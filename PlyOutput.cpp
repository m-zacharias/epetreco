...
namespace PlyOutput
{
  ...
  coord_type Vertex::get_x( void ) const {
    return x_;
  }
  
  coord_type Vertex::get_y( void ) const {
    return y_;
  }
  coord_type Vertex::get_z( void ) const {
    return z_;
  }
  ...
  Rectangle::Rectangle( Rectangle const & ori )
  : p0_(ori.p0_), p1_(ori.p1_), p2_(ori.p2_), p3_(ori.p3_) {}
  
  Rectangle::Rectangle( Vertex const & p0,
                        coord_type const & lx,
                        coord_type const & ly )
  : p0_(Vertex(p0.get_x(),    p0.get_y(),    p0.get_z())),
    p1_(Vertex(p0.get_x()+lx, p0.get_y(),    p0.get_z())),
    p2_(Vertex(p0.get_x()+lx, p0.get_y()+ly, p0.get_z())),
    p3_(Vertex(p0.get_x(),    p0.get_y()+ly, p0.get_z())) {}
  ...
  : p0_(p0),
    ...
    p2_(Vertex(p0.get_x()+lx, p0.get_y()+ly, p0.get_z())), 
    p3_(Vertex(p0.get_x(),    p0.get_y()+ly, p0.get_z())), 
    p4_(Vertex(p0.get_x(),    p0.get_y(),    p0.get_z()+lz)), 
    p5_(Vertex(p0.get_x()+lx, p0.get_y(),    p0.get_z()+lz)), 
    p6_(Vertex(p0.get_x()+lx, p0.get_y()+ly, p0.get_z()+lz)), 
    p7_(Vertex(p0.get_x(),    p0.get_y()+ly, p0.get_z()+lz)) {} 
  ...
  void Box::operator=( Box const & rval ) {
    p0_ = rval.p0_;
    p1_ = rval.p1_;
    p2_ = rval.p2_;
    p3_ = rval.p3_;
