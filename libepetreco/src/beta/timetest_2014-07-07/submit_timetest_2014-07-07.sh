#PBS -N timetest_2014-07-07
#PBS -q k20
#PBS -l nodes=1:ppn=8
#PBS -l walltime=48:00:00
#PBS -d /home/mz6084/svn/epetreco/trunk/libepetreco/src/beta/timetest_2014-07-07
#PBS -e ./error.log
#PBS -o ./output.log
...
if [ $? -eq 0 ]; then 
  ...
  for CHUNKSIZE in $CHUNKSIZES; do
    ...
    time ./$PROGRAM $TEST_FILE $CHUNKSIZE $RANDOM_SEED $NTHREADRAYS $PBS_O_WORKDIR/$CHUNKSIZE"__"$(basename $TEST_FILE)"_"
    echo -e "\n\n"
    done
  done
fi 
