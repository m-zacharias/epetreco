#PBS -N test_2014-09-23_02
#PBS -q k20
#PBS -l nodes=1:ppn=8
#PBS -l walltime=4:00:00
#PBS -d /home/mz6084/epetreco_synced-with-laptop/trunk/libepetreco/src/beta/test_2014-09-23_02
#PBS -e ./error.log
#PBS -o ./output.log
...
NRAYSPERTHREAD=(4096 256 128 64 32 16 8)
NTHREADSPERBLOCK=(1 16 32 64 128 256 512)
    ...
    for TEST_FILE in $TEST_FILES; do
      ...
      for i in `seq 0 6`; do
        ...
        { time ./$PROGRAM $TEST_FILE $CHUNKSIZE $RANDOM_SEED\
          ...
          $PBS_O_WORKDIR/${NRAYSPERTHREAD[$i]}"__"${NTHREADSPERBLOCK[$i]}"__"$(basename $TEST_FILE)"_"; } &>> $LOGFILE
        echo -e "\n\n" >> $LOGFILE
      done
    done
  done
